// import tranEmailApi from "../config/sendMail.js";
...
//     attachments: [
//       {
//         content: Buffer.from(await fs.promises.readFile(join(__dirname, "../public/images/century.png"))).toString("base64"),
//         name: "century.png",
//         cid: "logo",
//       },
//     ],
...
//     console.log("PIN email sent successfully via Sendinblue:", response);
//     return pin; // return PIN for DB/session
//   } catch (error) {
